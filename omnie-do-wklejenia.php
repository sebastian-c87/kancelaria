...
=======================================================================
  ...
  Kolejność działań:
  1. NAJPIERW wklej treść z omnie-do-wklejenia.html do edytora WP
     (Strony → O mnie → Edytuj → zakładka Tekst → wklej → Aktualizuj)
  2. POTEM wgraj ten plik jako page-o-mnie.php przez FTP/edytor motywu

  Co Kamila może edytować po tej zmianie:
  - 3 akapity bio (w WP Admin → Strony → O mnie → Edytuj → Wizualny)

  Co zostaje w PHP (nie wymaga edycji):
  - Hero, zdjęcie, podpis, statystyki, wartości, timeline, CTA
