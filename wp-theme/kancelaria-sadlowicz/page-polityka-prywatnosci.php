...
<section class="pp-hero">
    <div class="container">
        <p class="subtitle">Kancelaria Adwokacka Kamila Sadłowicz</p>
        <h1>Polityka Prywatności</h1>
        <p class="subtitle">Dokument obowiązuje od 1 lipca 2021 r. · Ostatnia aktualizacja: 5 czerwca 2026 r.</p>
    </div>
</section>
...
<div class="pp-content">
    ...
    <div class="pp-info-box">
        <p>Niniejsza Polityka Prywatności opisuje zasady przetwarzania danych osobowych przez Kancelarię Adwokacką Adwokat Kamila Sadłowicz w związku z korzystaniem z serwisu internetowego <strong>kancelaria-sadlowicz.pl</strong> oraz świadczeniem usług prawnych. Dokument jest zgodny z Rozporządzeniem Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia 27 kwietnia 2016 r. (RODO/GDPR) oraz polską ustawą o ochronie danych osobowych z dnia 10 maja 2018 r.</p>
    </div>

    <h2>§ 1. Administrator danych osobowych</h2>
    <p>Administratorem Twoich danych osobowych jest:</p>
    <ul>
        <li><strong>Kancelaria Adwokacka Adwokat Kamila Sadłowicz</strong></li>
        <li>NIP: 5213309586</li>
        <li>REGON: 389432583</li>
        <li>Adres: ul. Arbuzowa 12, lok. 1, 02-747 Warszawa (Mokotów)</li>
        <li>E-mail: <a href="mailto:kamila.sadlowicz@kancelaria-sadlowicz.pl">kamila.sadlowicz@kancelaria-sadlowicz.pl</a></li>
    ...
    <p>W zależności od celu przetwarzania możemy gromadzić następujące kategorie danych osobowych:</p>

    <h3>Formularz kontaktowy i korespondencja e-mail</h3>
    <ul>
    ...
    <h3>Usługi prawne (klienci Kancelarii)</h3>
    <ul>
    ...
    <h3>Dane zbierane automatycznie (strona internetowa)</h3>
    <ul>
        <li>Adres IP</li>
    ...
    <table class="pp-table">
        ...
        <tbody>
            <tr>
                <td>Niezbędne</td>
                <td>Serwer (session)</td>
                <td>Prawidłowe działanie strony, bezpieczeństwo</td>
                <td>Sesja / do zamknięcia przeglądarki</td>
            </tr>
            <tr>
                <td>Analityczne</td>
            ...
            <tr>
                <td>Funkcjonalne</td>
                <td>Google Fonts</td>
                <td>Wyświetlanie czcionek (połączenie z serwerami Google)</td>
                <td>1 rok</td>
            </tr>
        </tbody>
    </table>
    ...
    <p>Stosujemy odpowiednie środki techniczne i organizacyjne zapewniające bezpieczeństwo przetwarzania danych osobowych, w szczególności:</p>
    <ul>
        <li>Szyfrowanie transmisji danych za pomocą protokołu SSL/TLS (certyfikat HTTPS)</li>
    ...
    <p>Podanie danych osobowych za pośrednictwem formularza kontaktowego jest dobrowolne, ale niezbędne do udzielenia odpowiedzi na zapytanie. Niepodanie danych oznaczonych jako wymagane uniemożliwia skontaktowanie się z Kancelarią za pośrednictwem formularza.</p>
    <p>W przypadku danych zbieranych w związku ze świadczeniem pomocy prawnej, podanie danych może wynikać z wymagań ustawowych (np. obowiązek identyfikacji klienta zgodnie z ustawą o przeciwdziałaniu praniu pieniędzy i finansowaniu terroryzmu).</p>

    <h2>§ 11. Linki do zewnętrznych serwisów</h2>
    <p>Strona internetowa Kancelarii może zawierać odnośniki do zewnętrznych serwisów internetowych (m.in. LinkedIn, portale prawnicze). Kancelaria nie ponosi odpowiedzialności za polityki prywatności tych serwisów. Zalecamy zapoznanie się z politykami prywatności każdego odwiedzanego serwisu zewnętrznego.</p>

    <h2>§ 12. Zmiany Polityki Prywatności</h2>
    <p>Zastrzegamy prawo do wprowadzania zmian w niniejszej Polityce Prywatności, w szczególności w związku ze zmianami przepisów prawa, wytycznych organów nadzorczych lub rozwojem serwisu internetowego. O istotnych zmianach poinformujemy poprzez zamieszczenie zaktualizowanej wersji dokumentu na stronie internetowej wraz ze wskazaniem daty aktualizacji. Korzystanie z serwisu po opublikowaniu zmian oznacza ich akceptację.</p>
    <p>Aktualna wersja Polityki Prywatności jest zawsze dostępna pod adresem: <a href="https://kancelaria-sadlowicz.pl/polityka-prywatnosci.html">kancelaria-sadlowicz.pl/polityka-prywatnosci.html</a></p>

    <p class="pp-updated">Dokument sporządzony zgodnie z Rozporządzeniem Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia 27 kwietnia 2016 r. (RODO) oraz ustawą z dnia 10 maja 2018 r. o ochronie danych osobowych (Dz.U. 2019 poz. 1781). Ostatnia aktualizacja: 5 czerwca 2026 r.</p>
